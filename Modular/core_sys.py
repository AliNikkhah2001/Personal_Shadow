...
class ConfigManager:
    def __init__(self, fn="config.json"):
        ...
        self.defaults = {
            ...
            "font_color": "#e2e8f0",
            "font_size": 16,
            "clock_style": "Analog Classic",
            "clock_case_shape": "Round",
            "clock_bezel": "Plain",
            "clock_indices": "Baton",
            "clock_ticks": "Standard",
            "clock_hands": "Classic",
            "clock_complication": "None",
            "dist_delay": 3,
            "vision_mode": "Strict (Face & Eyes)",
            "bg_image_path": "img/bg.jpg",
            "quotes_path": "",
            "panel_opacity": 180,
            "face_scale_factor": 1.2,
            "face_min_neighbors": 8,
            "face_min_size": 120,
            "vision_sample_interval": 30,
            "force_close_apps_mins": 5,
            "sound_app_dist": "Ping",
            "sound_cam_dist": "Basso",
            "sound_cam_err": "Hero",
            "beep_freq": 3,
            "loop_1m": 2,
            "loop_5m": 5,
...
class DatabaseManager:
    ...
    def setup(self):
        self.c.executescript("""
            ...
            CREATE TABLE IF NOT EXISTS wallpapers (id INTEGER PRIMARY KEY, uuid TEXT UNIQUE, modified_at TEXT, name TEXT, image_data BLOB, mime_type TEXT, is_active INTEGER DEFAULT 0);
        """)
        self.safe_commit()
    ...
    def auto_migrate(self):
        ...
        for table in tables_to_sync:
            ...
            if rows:
                ...
                for r in rows:
                    self.c.execute(
                        f"UPDATE {table} SET uuid=?, modified_at=? WHERE id=?", (uuid.uuid4().hex, now, r[0])
                    )
