        ...
        const App = () => {
            ...
            const renderContent = () => {
                switch(currentView) {
                    ...
                    case 'bookshelf': return <div className="w-full h-full rounded-2xl overflow-hidden border border-white/10 shadow-2xl"><iframe src={window.__SHELF_URL__ || 'shelf/shelf.html'} className="w-full h-full border-0" title="3D Bookshelf" /></div>;
