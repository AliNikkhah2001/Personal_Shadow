window.ShelfCatalog = ([
  {
    ...
    description: "Charles T. Munger\u2019s talks and lessons become a practical latticework for clearer thinking, sound judgment, and a life shaped by continual learning.",
  ...
  },
  {
    ...
    description: "A civilizational history of upkeep\u2014from machines and manuals to military sustainment\u2014and an argument for care as a radical, future-making practice.",
  ...
  },
  {
    ...
    author: "Brian Potter",
    description: "A whole-systems investigation into how production becomes faster, cheaper, and more reliable\u2014and how those gains create material abundance.",
  ...
  },
  {
    ...
    description: "An oral history of modern AI told through conversations with the researchers and founders shaping large models, explosive growth, and what comes next.",
  ...
  },
  {
    ...
    description: "A study of how bubbles assemble capital, talent, urgency, and risk\u2014and why those volatile conditions can unlock transformative innovation.",
  ...
  },
  {
    ...
    description: "An empathetic operating manual for leaders building durable organizations, complete with practical systems for hiring, feedback, performance, and planning.",
  ...
  },
  {
    ...
    description: "A first-person account of coordinating scientists, institutions, and government at enormous scale\u2014and the leadership required to turn research into action.",
  ...
  },
  {
    ...
    description: "A spirited investigation into technological stagnation and the ambition required to build a future of physical abundance, mobility, and wonder.",
  ...
  },
  {
    ...
    description: "A panoramic history of Silicon Valley\u2019s hardware beginnings, following the engineers, entrepreneurs, and semiconductor breakthroughs behind an industry.",
  ...
  },
  {
    ...
    description: "A case for protecting unconventional researchers from consensus-driven funding systems so that improbable, field-changing discoveries can survive.",
  ...
  },
  {
    ...
    author: "Nadia Eghbal",
    description: "An intimate look at open-source communities, their creators, and the social and economic structures hidden beneath software\u2019s public surface.",
  ...
  },
  {
    ...
    description: "Richard Hamming\u2019s reflections on great work, creative problem-solving, and the habits that help scientists and engineers tackle consequential questions.",
  ...
  },
  {
    ...
    description: "The candid development journals behind a landmark game, tracing creative decisions, technical constraints, doubt, and invention in real time.",
  ...
  },
  {
    ...
    description: "A practical guide to finding a community\u2019s first believers, helping them participate, and building rituals that turn an audience into belonging.",
  ...
  },
  {
    ...
    author: "Will Larson",
    description: "A systems-minded handbook for engineering leaders confronting organizational design, team growth, technical strategy, and the human side of scale.",
  ...
  },
  {
    ...
    author: "Martin Gurri",
    description: "An account of how networked publics shattered old information monopolies, destabilized institutions, and transformed political authority.",
  ...
  },
  {
    ...
    author: "Tyler Cowen",
    description: "A philosophical argument for sustainable economic growth, human rights, and moral concern for the lives of people in the distant future.",
  ...
  },
  {
    ...
    description: "The sweeping history of the visionaries who imagined interactive computing and transformed the computer from calculating machine into personal medium.",
  ...
  },
  {
    ...
    author: "Elad Gil",
    description: "A field guide to the inflection points that arrive after product-market fit, drawing practical lessons from leaders who have scaled enduring companies.",
