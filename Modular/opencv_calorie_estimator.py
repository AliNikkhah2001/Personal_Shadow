...
class FoodCalorieEstimator:
    ...
    def __init__(self, nutrition_db: Optional[Dict] = None):
    ...
    def load_models(self, detection_model_path: str = None, segmentation_model_path: str = None):
    ...
    def detect_reference_object(self, image: np.ndarray) -> Optional[Tuple[float, Tuple[int, int, int, int]]]:
    ...
    def estimate_calories(self, image: np.ndarray) -> List[FoodDetection]:
        ...
        for bbox in food_boxes:
            ...
            nutrition = self.nutrition_db.get(food_name.lower(), {
                "kcal_per_100g": 150,
                "protein_per_100g": 10,
                "fat_per_100g": 5,
                "carbs_per_100g": 20
